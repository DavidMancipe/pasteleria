...
public class ComprasDAO {
    ...
    public List Detalle(int id){
        List lista = new ArrayList();
       String sql="select DC.idDetalle, P.Nombre, DC.idCompras, DC.Cantidad, DC.PrecioCompra from detalle_compras DC inner join producto P on P.idProducto = DC.idProducto where idCompras="+  id;
       try {
           con = cn.Conexion();
           ps = con.prepareStatement(sql);
           rs = ps.executeQuery();
